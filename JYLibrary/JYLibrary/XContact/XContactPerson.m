...
+ (NSString *)chineseForLabel:(NSString *)label {
    ...
    if ([label isEqualToString:xPersonPhoneLabelHome]) label = @"家庭";
    else if ([label isEqualToString:xPersonPhoneLabelWork]) label = @"工作";
    else if ([label isEqualToString:xPersonPhoneLabelOther]) label = @"其他";
    else if ([label isEqualToString:xPersonPhoneLabelMobile]) label = @"手机";
    else if ([label isEqualToString:xPersonPhoneLabelIPhone]) label = @"iPhone";
    else if ([label isEqualToString:xPersonPhoneLabelMain]) label = @"主要";
    else if ([label isEqualToString:xPersonPhoneLabelHomeFAX]) label = @"家庭传真";
    else if ([label isEqualToString:xPersonPhoneLabelWorkFAX]) label = @"工作传真";
    else if ([label isEqualToString:xPersonPhoneLabelOtherFAX]) label = @"其他传真";
    else if ([label isEqualToString:xPersonPhoneLabelPager]) label = @"传呼";
    
    else if ([label isEqualToString:xPersonEmailLabelHome]) label = @"家庭";
    else if ([label isEqualToString:xPersonEmailLabelWork]) label = @"工作";
    else if ([label isEqualToString:xPersonEmailLabelOther]) label = @"其他";
    else if ([label isEqualToString:xPersonEmailLabelICloud]) label = @"iCloud";
    
    else if ([label isEqualToString:xPersonAddressLabelHome]) label = @"家庭";
    else if ([label isEqualToString:xPersonAddressLabelWork]) label = @"工作";
    else if ([label isEqualToString:xPersonAddressLabelOther]) label = @"其他";
    
    else if ([label isEqualToString:xPersonAddressKeyCountry]) label = @"国家";
    else if ([label isEqualToString:xPersonAddressKeyState]) label = @"省份";
    else if ([label isEqualToString:xPersonAddressKeyCity]) label = @"城市";
    else if ([label isEqualToString:xPersonAddressKeyStreet]) label = @"街道";
    else if ([label isEqualToString:xPersonAddressKeyCountryCode]) label = @"国家代码";
    else if ([label isEqualToString:xPersonAddressKeyZIP]) label = @"邮政编码";
